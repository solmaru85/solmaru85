...
#define DEFAULT_LOG_LEVEL 		WS_LOGLEVEL_DISP

char *g_lpszLogFilePath = "/sdcard/Documents/Daree.log";
//char *g_lpszLogFilePath = "/sdcard/Documents/WLog.log";
//char *g_lpszLogFilePath = "/storage/AAC1-11F4/Dareesoft/Daree.log";
...
void _Logging(int iLogLevel, const char *szFileSrc, const char *szFuncName, const int iLine, const char *fmt, ...)
{
	...
	char *lpszFileSrc = strrchr(szFileSrc, '/');
	if( lpszFileSrc == NULL )	lpszFileSrc = szFileSrc;
	else						lpszFileSrc++;
